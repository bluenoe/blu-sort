...
struct PreviewResp { items: Vec<sorter_core::PlanItem>, total: usize, duplicates: usize }
...
Ok(PreviewResp { items, total: sum.total, duplicates: sum.duplicates })
}


#[derive(Debug, Deserialize)]
struct ApplyReq { dir: String, items: Vec<sorter_core::PlanItem> }
